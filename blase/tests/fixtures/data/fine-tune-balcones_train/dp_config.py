...
config = {
    ...
    "feature_modules_path": (
        "/workspace/projects/fx_classify_demo/data_preparation/fx_classify_feature_engineering.py"
    ),
    ...
    "target_batch": 4,
    "target_modules_path": (
        "/workspace/projects/fx_classify_demo/data_preparation/fx_classify_target_engineering.py"
    ),
