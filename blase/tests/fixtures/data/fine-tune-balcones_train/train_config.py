...
config = {
    ...
    "data_processing_modules_path": (
        "/workspace/projects/fx_classify_demo/training/fx_classify_process_raw_data.py"
    ),
    ...
    "feature_scaling": {
        "test_features": ("CLEAN_FEATURE_DATABASE", ["test_technical_feature_data"])
    },
    ...
    "prep_and_save": {
        "test_features": (
            "CLEAN_FEATURE_DATABASE",
            {
                "test_hourly_feature_data": {"scaler": True, "keep_primary_key": False},
    ...
    "weight_dict_save_path": (
        "/workspace/projects/fx_classify_demo/training/weights_dict/target_weights_dict.json"
    ),
    # Args for training
    # Reshape (number of windows (48 hours of ohlc=48), size of windows (ohlc=4))
    "feature_categories": {
        "test_hourly_feature_data": {"reshape": True, "shape": (12, 4)},
        "test_technical_feature_data": {"reshape": False, "shape": None},
        "test_engineered_feature_data": {"reshape": False, "shape": None},
    },
    "model_modules_path": (
        "/workspace/projects/fx_classify_demo/training/fx_classify_custom_train_funcs.py"
    ),
