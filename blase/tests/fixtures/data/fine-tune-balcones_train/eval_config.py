...
config = {
    ...
    "backtest": {
        "dir": (
            "/workspace/projects/fx_classify_demo/training/iterations/04_03_2025_14_49_49"
        ),
        ...
        "save_pred_dir": (
            "/workspace/projects/fx_classify_demo/evaluation/predictions"
        ),
    ...
    "explain": {
        ...
        "id_cols": ["date", "pair"],
        "prediction_dir": (
            "/workspace/projects/fx_classify_demo/evaluation/predictions/04_03_2025_14_49_49_epoch10.db"
        ),
    },
    "metrics": {
        "db": (
    ...
    "candidates": {
        ...
        "y_pred": "predicted_category",
        "y_conf": "confidence",
        "class_filter": {"column_name": "predicted_category", "classes": [1, 2]},
        "asset_col": "pair",
        # The custom function must use df as an arguement
        "custom_func": True,
        "custom_func_path": (
            "/workspace/projects/fx_classify_demo/evaluation/fx_classify_custom_eval_funcs.py"
        ),
